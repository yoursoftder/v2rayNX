...
namespace vNet
{
    class Global
    {
        ...
        /// v2ray客户端配置样例文件名
        /// </summary>
        public const string v2raySampleClient = "vNet.Sample.SampleClientConfig.txt";
        /// <summary>
        /// v2ray服务端配置样例文件名
        /// </summary>
        public const string v2raySampleServer = "vNet.Sample.SampleServerConfig.txt";
        /// <summary>
        /// v2ray配置Httprequest文件名
        /// </summary>
        public const string v2raySampleHttprequestFileName = "vNet.Sample.SampleHttprequest.txt";
        /// <summary>
        /// v2ray配置Httpresponse文件名
        /// </summary>
        public const string v2raySampleHttpresponseFileName = "vNet.Sample.SampleHttpresponse.txt";
        /// <summary>
        /// 空白的pac文件
        /// </summary>
        public const string BlankPacFileName = "vNet.Sample.BlankPac.txt";

        public const string CustomRoutingFileName = "vNet.Sample.custom_routing_";
        ...
        /// MyRegPath
        /// </summary>
        public const string MyRegPath = "Software\\vNetNGUI";
        ...
        /// Icon
        /// </summary>
        public const string CustomIconName = "Network.theme-dark.ico";
        ...
        public static int addhttpport
        {
            get; set;
        }
        public static int addvmessport
        {
            get; set;
        }
